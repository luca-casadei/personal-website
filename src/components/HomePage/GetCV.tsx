    ...
    return (
        <section className="flex md:flex-row flex-col md:gap-10 gap-5 md:items-start items-center">
            ...
            <div className="flex flex-col w-full gap-5">
                ...
                <a className="p-2 text-center hover:border-white border-oxford-blue border-solid border-2 self-center rounded-lg md:w-1/5 bg-gradient-to-bl hover:from-orange-400 hover:to-pink-500 from-amber-400 to-red-500" href="https://github.com/luca-casadei/CV/releases/download/v27-08-2024/CVLucaCasadei.pdf">Scarica</a>
            </div>
        </section>
    )
}